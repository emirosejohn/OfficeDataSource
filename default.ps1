properties {
	...
	$databaseScripts = "$baseDir\data\mssql\OfficeLocation\TransitionsScripts"
	...
	$packageXunitExec = "$srcFolder\packages\xunit.runner.console.2.0.0\tools\xunit.console.exe" #check the folder version
}
...
task RebuildDatabase {
	$dbFileDir = "$dataFolder\mssql\OfficeLocation"
